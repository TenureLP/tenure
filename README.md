...
<img src="landing/assets/logo-mark-512.png" alt="" width="104">
...
| [`landing/`](landing) | The home page, and a page for Olanas. Static, no script. | deployed |
| [`docs-site/`](docs-site) | The documentation site, built with VitePress. | deployed |
