...
| [`lp-api/`](lp-api) | Position valuation over JSON-RPC, exact integer maths, behind an HTTP 402 gate that speaks x402 v2. | 42 tests, runs against mainnet |
...
That builds the contracts, runs 39 Solidity tests including a stateful fuzz over random action
